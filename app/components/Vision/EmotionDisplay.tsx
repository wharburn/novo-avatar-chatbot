...
function EmotionBox({ 
  ...
  return (
    <div 
      className="flex-1 h-[30px] rounded-sm flex items-center justify-center text-[11px] font-medium transition-all duration-300"
      style={{ 
...
function EmotionRow({ 
  ...
  return (
    <div className="flex items-center gap-1 px-2">
      <span className="text-[11px] font-semibold text-gray-600 w-12 shrink-0">
        {label}
      </span>
  ...
  return (
    <div className="w-full bg-white/90 backdrop-blur-sm border-b border-gray-200 py-2 space-y-1">
      ...
      <EmotionRow 
        ...
        isActive={voiceEmotions.length > 0}
      />
